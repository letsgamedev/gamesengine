...
// ENGINES
var SCIMITAR = ['Scimitar', 'https://de.wikipedia.org/wiki/Anvil_(Spiel-Engine)']
var ANVIL = ['Anvil', 'https://de.wikipedia.org/wiki/Anvil_(Spiel-Engine)']
var ANVIL_NEXT = ['AnvilNext', 'https://de.wikipedia.org/wiki/Anvil_(Spiel-Engine)']
var ANVIL_NEXT_2 = ['AnvilNext 2.0', 'https://de.wikipedia.org/wiki/Anvil_(Spiel-Engine)']
var CLICK_TEAM_FUSION = ['Clickteam Fusion 2.5', 'http://www.clickteam.com/clickteam-fusion-2-5']
var COBRA_ENGINE = ['Cobra', 'https://www.frontier.co.uk/node/639']
var COCOS2D = ['Cocos2D', 'http://cocos2d.org/']
var COCOS2DX = ['Cocos2D-x', 'http://www.cocos2d-x.org/']
var CONSTRUCT2 = ['Construct 2', 'https://www.scirra.com/']
var CREATION_ENGINE = ['Creation-Engine', 'https://en.wikipedia.org/wiki/Creation_Engine']
var CRYENGINE1 = ['CryEngine 1', 'https://www.cryengine.com/']
var CRYENGINE2 = ['CryEngine 2', 'https://www.cryengine.com/']
var CRYENGINE3 = ['CryEngine 3', 'https://www.cryengine.com/']
var CRYENGINEV = ['CryEngine V', 'https://www.cryengine.com/']
var DIESEL = ['Diesel', 'https://en.wikipedia.org/wiki/Diesel_(game_engine)']
var FROSTBITE = ['Frostbite', 'https://www.ea.com/frostbite']
var GAME_MAKER1 = ['Game Maker Studio', 'https://www.yoyogames.com/']
var GAME_MAKER2 = ['Game Maker Studio 2', 'https://www.yoyogames.com/']
var GAMEBRYO = ['Gamebryo', 'http://www.gamebryo.com/']
var GODOT = ['Godot', 'https://godotengine.org/']
var GOLD_SRC = ['GoldSrc', 'https://de.wikipedia.org/wiki/GoldSrc']
var IGNITE = ['Ignite' , 'http://www.easports.com/ignite']
var J_MONKEY_ENGINE = ['jMonkeyEngine', 'http://jmonkeyengine.org/']
var LIBGDX = ['LibGDX', 'https://libgdx.badlogicgames.com/']
var LUMBERYARD = ['Lumberyard Engine', 'https://aws.amazon.com/de/lumberyard/']
var LWJGL = ['LWJGL', 'https://www.lwjgl.org/']
var MADNESS = ['MADNESS Engine', 'http://www.slightlymadstudios.com/tech.html']
var MONOGAME = ['MonoGame', 'http://www.monogame.net/']
var OWN_ENGINE = ['Own Engine', '']
var OPENGLES = ['OpenGL ES', 'https://www.khronos.org/opengles/']
var PHASERJS = ['Phaser.js', 'https://phaser.io/']
var RAGE = ["Rockstar Advanced Game Engine", 'https://en.wikipedia.org/wiki/Rockstar_Advanced_Game_Engine']
var REAL_VIRTUALITY_4 = ['Real Virtuality 4', 'https://arma3.com/features/engine']
var RED_ENGINE = ['REDengine 2/3/4', 'https://en.wikipedia.org/wiki/REDengine']
var RENDERWARE = ['RenderWare', 'http://web.archive.org/web/20060814225229/http://www.renderware.com/']
var SERIOUS4 = ['Serious Engine 4', 'http://www.croteam.com/technology/']
var SOURCE = ['Source Engine', 'https://de.wikipedia.org/wiki/Source_Engine']
var SOURCE2 = ['Source 2', 'http://de.valve.wikia.com/wiki/Source_2_Engine']
var UNITY = ['Unity', 'https://unity3d.com']
var UNREAL2_5 = ['Unreal Engine 2.5', 'https://www.unrealengine.com/what-is-unreal-engine-4']
var UNREAL3 = ['Unreal Engine 3', 'https://www.unrealengine.com/what-is-unreal-engine-4']
var UNREAL4 = ['Unreal Engine 4', 'https://www.unrealengine.com/what-is-unreal-engine-4']
var VISION = ["Havok Vision", 'https://en.wikipedia.org/wiki/Vision_(game_engine)']
var XNA = ['Microsoft XNA', 'https://en.wikipedia.org/wiki/Microsoft_XNA']
...
GAMES = [
  ...
  {name: 'Tower Unite', engine: UNREAL4, releaseDate: {d: 8, m: 4, y: 2016}, imgId: 'tower-unite', yt: 'MdXzTkCn7r0' } //https://store.steampowered.com/app/394690/Tower_Unite/; https://trello.com/c/KvRfp3y1/325-migration-to-unreal-418
]
