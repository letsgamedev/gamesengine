  ...
  methods: {
    ...
    getLink (v) {
      switch (v) {
        ...
        case RAGE: return 'https://en.wikipedia.org/wiki/Rockstar_Advanced_Game_Engine'
        ...
        case RENDERWARE: return 'http://web.archive.org/web/20060814225229/http://www.renderware.com/'
        ...
        case VISION: return 'https://en.wikipedia.org/wiki/Vision_(game_engine)'
